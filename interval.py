...
def brute_force_private_key(target_public_key, lower_bound_hex, upper_bound_hex, report_interval=100):
    ...
    for i in range(lower_bound, upper_bound + 1):
        ...
        if i % report_interval == 0:
            ...
            print(f"Attempt {i}/{upper_bound} - Elapsed Time: {elapsed_time:.2f} seconds {private_key.hex()}")
    
    return None

# Example usage
target_public_key_hex = '03633cbe3ec02b9401c5effa144c5b4d22f87940259634858fc7e59b1c09937852'
lower_bound_hex = '200000000000000000000000000071410'
upper_bound_hex = '3ffffffffffffffffffffffffffffffff'
found_private_key = brute_force_private_key(target_public_key_hex, lower_bound_hex, upper_bound_hex)
