...
def brute_force_private_key(target_public_key, max_attempts=1000, report_interval=100):
    ...
    for i in range(max_attempts):
        ...
        if i % report_interval == 0:
            ...
            print(f"Attempt {i}/{max_attempts} - Elapsed Time: {elapsed_time:.2f} seconds")
    
    return None

# Example usage with a reduced key space
target_public_key_hex = '03633cbe3ec02b9401c5effa144c5b4d22f87940259634858fc7e59b1c09937852'
found_private_key = brute_force_private_key(target_public_key_hex, max_attempts=1000)
